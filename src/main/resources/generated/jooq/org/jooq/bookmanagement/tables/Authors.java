...
import org.jooq.bookmanagement.tables.Books.BooksPath;
...
public class Authors extends TableImpl<AuthorsRecord> {
    ...
    /**
     * The column <code>public.authors.del_flag</code>.
     */
    public final TableField<AuthorsRecord, Integer> DEL_FLAG = createField(DSL.name("del_flag"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
