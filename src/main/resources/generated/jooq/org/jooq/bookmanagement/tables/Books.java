 ...
 */
package org.jooq.bookmanagement.tables;
...
import org.jooq.bookmanagement.Keys;
import org.jooq.bookmanagement.Public;
import org.jooq.bookmanagement.tables.Authors.AuthorsPath;
...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(200).nullable(false), this, "");
     ...
     */
    public final TableField<BooksRecord, LocalDate> PUBLISHED_DATE = createField(DSL.name("published_date"), SQLDataType.LOCALDATE, this, "");
    ...
    /**
     * The column <code>public.books.del_flag</code>.
     */
    public final TableField<BooksRecord, Integer> DEL_FLAG = createField(DSL.name("del_flag"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
